...
class DedeSql
{
	...
	{
		$errorTrackFile = dirname(__FILE__).'/../data/mysql_error_trace_yidituseh_cctv_smtv.inc';
		if( file_exists(dirname(__FILE__).'/../data/mysql_error_trace.php') )
		{
			@unlink(dirname(__FILE__).'/../data/mysql_error_trace.php');
		}
		$emsg = '';
		$emsg .= "<div><h3>管理系统错误提示：</h3>\r\n";
		$emsg .= "<div><a href='http://www.uqbook.cn' target='_blank' style='color:red'>技术支持：QQ: 153710139</a></div>";
		$emsg .= "<div style='line-helght:160%;font-size:14px;color:green'>\r\n";
		$emsg .= "<div style='color:blue'><br />错误页面: <font color='red'>".$this->GetCurUrl()."</font></div>\r\n";
		$emsg .= "<div>错误信息: {$msg}</div>\r\n";
		$emsg .= "<br /></div></div>\r\n";
