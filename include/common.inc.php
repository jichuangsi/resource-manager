...
{
    exit('<a href="http://www.uqbook.cn/doku.php?id=register_globals">php.ini register_globals must is Off! </a>');
}

//禁止 session.auto_start
if ( ini_get('session.auto_start') != 0 )
{
    exit('<a href="http:///www.uqbook.cn/doku.php?id=session_auto_start">php.ini session.auto_start must is 0 ! </a>');
}
...
$cfg_version = 'V1.0_UTF8';
$cfg_soft_lang = 'utf-8';
$cfg_soft_public = 'base';

$cfg_softname = '维软内容管理系统';
$cfg_soft_enname = 'UQ_CMS';
$cfg_soft_devteam = '倚地屠蛇,yiditushe@163.com';
