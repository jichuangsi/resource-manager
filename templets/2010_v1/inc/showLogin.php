...
<div id="login">
    ...
    <div style="width:320px;height:90px;margin:0px auto;">
        ...
        <div id="btnlogin"><a href="#"><img src="<?php echo $cfg_templets_skin; ?>/images/login.gif" width="55" height="55" onclick="parent.winLogin($('#userid').val(), $('#pwd').val(), $('#vdcode').val(), '<?php echo $todo; ?>');" /></a></div>
    </div>
